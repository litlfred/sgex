...
**Note:** This example validates `sushi-config.yaml` which is required by FSH/SUSHI tooling. The YAML restriction applies to SGeX application features, not external tooling requirements.
