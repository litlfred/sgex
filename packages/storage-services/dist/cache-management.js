...
exports.cacheManagementService = exports.CacheManagementService = void 0;
class CacheManagementService {
    constructor() {
        this.DAK_CACHE_PREFIXES = [
            'sgex_repo_cache_',
            'sgex-bookmarks',
            'sgex_branch_context',
     ...
     */
    clearDAKRepositoryCache(dakRepository) {
    ...
    clearLocalStorageCache() {
        const keys = Object.keys(localStorage);
        const cacheKeys = keys.filter(key => this.DAK_CACHE_PREFIXES.some(prefix => key.startsWith(prefix)));
    ...
    clearMemoryCaches() {
        ...
        if (typeof window !== 'undefined' && window.sgexMemoryCaches) {
            window.sgexMemoryCaches = {};
        }
    }
    getStorageInfo(storage) {
        const keys = Object.keys(storage);
        const dakKeys = keys.filter(key => this.DAK_CACHE_PREFIXES.some(prefix => key.startsWith(prefix)));
...
exports.cacheManagementService = new CacheManagementService();
