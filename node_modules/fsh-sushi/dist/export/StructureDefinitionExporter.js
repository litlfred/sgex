...
class StructureDefinitionExporter {
    ...
    setRules(structDef, fshDefinition) {
        ...
        rules
            .filter(r => r instanceof rules_1.CaretValueRule)
            .forEach((r) => {
            if (r.path === '' && r.isInstance) {
                directResourcePaths.push(r.caretPath);
            }
            else if (r.caretPath.endsWith('.resourceType') &&
        ...
        for (let i = 0; i < rules.length; i++) {
            ...
            if (element) {
                try {
                    if (rule instanceof rules_1.CardRule) {
                        ...
                        if (rule.isInstance) {
                            ...
                            if (instance._instanceMeta.usage === 'Example') {
                                utils_1.logger.warn(`Contained instance "${rule.value}" is an example and probably should not be included in a conformance resource.`, rule.sourceInfo);
                            }
                            rule.value = instance;
                        }
                        ...
                        if (replacedRule.path !== '') {
                            ...
                            const matchingInlineResourcePaths = inlineResourcePaths.filter(i => {
                                return (replacedRule.path === i.path &&
                            ...
                            matchingInlineResourcePaths.forEach(match => {
                                inlineResourceTypes[(0, common_1.splitOnPathPeriods)(match.caretPath).length - 1] =
                                    match.instanceOf;
                            });
                            ...
                            if (replacedRule.isInstance) {
                                ...
                                try {
                                    structDef.setInstancePropertyByPath(replacedRule.caretPath, replacedRule.value, this, inlineResourceTypes);
                                }
                                catch (originalErr) {
                                    if (originalErr instanceof errors_1.MismatchedTypeError &&
                                        ['number', 'bigint', 'boolean'].includes(typeof rule.value)) {
                    ...
                    utils_1.logger.error((_e = e.message) !== null && _e !== void 0 ? _e : e, rule.sourceInfo);
                    if (e.stack) {
                        utils_1.logger.debug(e.stack);
                    }
                }
    ...
    applyDeferredRules() {
        ...
        this.deferredCaretRules.forEach((rules, sd) => {
            ...
            for (const { rule, tryFish, originalErr } of rules) {
                ...
                if (tryFish) {
                        ...
                        try {
                            ...
                            if (successfulInstanceAssignments.has(sd)) {
                                ...
                                successfulInstanceAssignments.set(sd, [
                                    {
                                        caretPath: rule.caretPath,
                                        resourceType: (_e = (_d = (_c = (_b = (_a = fishedValue.meta) === null || _a === void 0 ? void 0 : _a.profile) === null || _b === void 0 ? void 0 : _b[0]) !== null && _c !== void 0 ? _c : fishedValue._instanceMeta.instanceOfUrl) !== null && _d !== void 0 ? _d : fishedValue._instanceMeta.sdType) !== null && _e !== void 0 ? _e : fishedValue.resourceType
                                    }
                                ]);
                            }
                        }
                    ...
                    const matchingInstancePaths = ((_f = successfulInstanceAssignments.get(sd)) !== null && _f !== void 0 ? _f : []).filter(i => {
        ...
        sdsToCleanAgain.forEach(sd => {
            var _a;
            (_a = sd.contained) === null || _a === void 0 ? void 0 : _a.forEach(containedResource => {
                (0, common_1.cleanResource)(containedResource);
            });
        });
    ...
    exportStructDef(fshDefinition) {
        ...
        (0, common_1.checkForMultipleChoice)(fshDefinition, structDef, structDef.getOwnStructureDefinition(this.fisher));
