...
class ElementDefinitionType {
    ...
    static fromJSON(json) {
        json = (0, lodash_1.cloneDeep)(json);
...
class ElementDefinition {
    ...
    constructor(id = '') {
        this.id = id;
        this._replacementProps = (0, lodash_1.cloneDeep)(REPLACEMENT_PROPS);
    }
    get id() {
    ...
    validateSlicing(slicing) {
        ...
        (_a = slicing.discriminator) === null || _a === void 0 ? void 0 : _a.forEach((d, i) => {
            ...
            if (isR4) {
                ...
                validationErrors.push(this.validateIncludes(d.type, ALLOWED_DISCRIMINATOR_TYPES_R5, `${discriminatorPath}.type`));
                if (d.type === 'position' && slicing.ordered !== true) {
                    validationErrors.push(new errors_1.ValidationError('Slicing ordering must be true when a position discriminator is used.', 'slicing.ordered'));
                }
            }
    ...
    clearOriginalProperty(pathParts) {
        let currentOriginalElement = this._original;
        // eslint-disable-next-line
        let currentActualElement = this;
        ...
        for (const [i, pathPart] of clearPath.entries()) {
            if (i < clearPath.length - 1) {
                ...
                currentOriginalElement = currentOriginalElement === null || currentOriginalElement === void 0 ? void 0 : currentOriginalElement[key];
                currentActualElement = currentActualElement === null || currentActualElement === void 0 ? void 0 : currentActualElement[key];
                const currentIndex = (0, common_2.getArrayIndex)(pathPart);
                ...
                if ((currentOriginalElement === null || currentOriginalElement === void 0 ? void 0 : currentOriginalElement[pathPart.base]) != null) {
                    currentOriginalElement[pathPart.base] = undefined;
                    currentActualElement[pathPart.base] = undefined;
                }
                if (pathPart.primitive && (currentOriginalElement === null || currentOriginalElement === void 0 ? void 0 : currentOriginalElement[`_${pathPart.base}`]) != null) {
    ...
    calculateClearPath(pathParts) {
        const replacementIndex = this._replacementProps.findIndex(replacementPath => replacementPath.length <= pathParts.length &&
    ...
    applyAddElementRule(rule, fisher) {
        ...
        this.constraint = (0, lodash_1.cloneDeep)(elementSD.snapshot.element[0].constraint).map((c) => {
    ...
    setInstancePropertyByPath(path, value, fisher) {
        (0, common_2.setPropertyOnDefinitionInstance)(this, path, value, fisher);
    }
    getSlices() {
        var _a, _b, _c, _d;
        if (this.sliceName) {
            // this.parent() should never be undefined if this element has a sliceName, but code defensively just in case
            return ((_b = (_a = this.parent()) === null || _a === void 0 ? void 0 : _a.children(true)) !== null && _b !== void 0 ? _b : this.structDef.elements).filter(e => e.id !== this.id && e.path === this.path && e.id.startsWith(`${this.id}/`));
        }
        else {
            return ((_d = (_c = this.parent()) === null || _c === void 0 ? void 0 : _c.children(true)) !== null && _d !== void 0 ? _d : this.structDef.elements).filter(e => e.id !== this.id && e.path === this.path && e.id.startsWith(`${this.id}:`));
        }
    }
    /**
    ...
    findConnectedElements(postPath = '') {
        ...
        const connectedElements = slicesToUse
            ...
            .filter(e => e);
        if (this.parent()) {
            const [parentPath] = (0, common_2.splitOnPathPeriods)(this.id).slice(-1);
    ...
    findParentSlice() {
        ...
        if (this.sliceName) {
            ...
            const potentialParentNames = parentNameParts
                ...
                .reverse();
            const elementsToSearch = (_b = (_a = this.parent()) === null || _a === void 0 ? void 0 : _a.children(true)) !== null && _b !== void 0 ? _b : this.structDef.elements;
    ...
    constrainType(rule, fisher, target) {
        ...
        if (((_f = typeMatches.get('Extension')) === null || _f === void 0 ? void 0 : _f.length) > 0) {
            ...
            typeMatches.get('Extension').forEach(typeMatch => {
                ...
                if (fullExtension) {
                    const isModifier = (0, common_2.isModifierExtension)(fullExtension);
    ...
    getTargetType(target, fisher) {
        ...
        if (target) {
            ...
            targetType = (0, lodash_1.cloneDeep)(this.type.find(t => {
                var _a, _b;
                return t.code === targetSD.id || // TODO: Should this be on type (for LMs?)
    ...
    findTypeMatch(type, targetTypes, fisher) {
        ...
        if (!matchedType) {
            throw new errors_1.InvalidTypeError((0, common_1.typeString)([type]), targetTypes);
        }
     ...
     */
    getTypeLineage(type, fisher, includeImposeProfiles = false, seenUrls = []) {
        const results = [];
        ...
        while (currentType != null) {
            ...
            let result = fisher.fishForMetadata(currentType, utils_1.Type.Resource, utils_1.Type.Logical, utils_1.Type.Type, utils_1.Type.Profile, utils_1.Type.Extension);
            if (result == null) {
                const [name, ...versionParts] = currentType.split('|');
                const version = versionParts.join('|') || null;
                result = fisher.fishForMetadata(name, utils_1.Type.Resource, utils_1.Type.Logical, utils_1.Type.Type, utils_1.Type.Profile, utils_1.Type.Extension);
        ...
        if (includeImposeProfiles) {
            ...
            results.forEach(md => {
                var _a;
                (_a = md.imposeProfiles) === null || _a === void 0 ? void 0 : _a.forEach(p => {
                    var _a;
                    const url = p instanceof fshtypes_1.FshCanonical
                        ? (_a = fisher.fishForMetadata(p.entityName, utils_1.Type.Resource, utils_1.Type.Logical, utils_1.Type.Type, utils_1.Type.Profile, utils_1.Type.Extension)) === null || _a === void 0 ? void 0 : _a.url
                        : p;
    ...
    applyProfiles(newType, targetType, matches) {
        ...
        for (const match of matches) {
            ...
            else if ((0, common_2.isReferenceType)(match.code) && !(0, common_2.isReferenceType)(match.metadata.sdType)) {
    ...
    applyTypeIntersection(type, targetType, matches) {
        ...
        for (const match of matches) {
            ...
            const typeString = (0, common_2.isReferenceType)(match.code) || match.code === 'canonical'
                ? match.code
     ...
     */
    bindToVS(vsURI, strength, ruleSourceInfo, fisher) {
        ...
        const isBindable = validTypes.length ||
            ((_a = this.type) === null || _a === void 0 ? void 0 : _a.some(type => { var _a; return (_a = fisher === null || fisher === void 0 ? void 0 : fisher.fishForMetadata(type.code, utils_1.Type.Logical)) === null || _a === void 0 ? void 0 : _a.canBind; }));
        if (!isBindable) {
            if ((_b = this.type) === null || _b === void 0 ? void 0 : _b.some(type => (fisher === null || fisher === void 0 ? void 0 : fisher.fishForMetadata(type.code, utils_1.Type.Logical)) != null)) {
                // Only warn if it was from a logical model that doesn't have #can-bind characteristic
                utils_1.logger.warn(`Bindings can only be applied to logical model types with the #can-bind characteristic. Update the target logical model to declare the #can-bind characteristic or remove the binding from ${this.id}.`, ruleSourceInfo);
            }
            else {
        ...
        if (this.type.length === 1 &&
            ...
            ((_e = (_d = (_c = this.parent()) === null || _c === void 0 ? void 0 : _c.type) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.code) === 'CodeableReference') {
        ...
        if (((_f = listElement === null || listElement === void 0 ? void 0 : listElement.binding) === null || _f === void 0 ? void 0 : _f.valueSet) == vsURI &&
            strengths.indexOf(strength) < strengths.indexOf((_g = listElement === null || listElement === void 0 ? void 0 : listElement.binding) === null || _g === void 0 ? void 0 : _g.strength)) {
            throw new errors_1.BindingStrengthError((_h = listElement === null || listElement === void 0 ? void 0 : listElement.binding) === null || _h === void 0 ? void 0 : _h.strength, strength);
        }
        if (vsURI == null) {
            ...
            if (!(0, valid_url_1.isUri)(vsURI.split('|')[0]) && !vsURI.startsWith('#')) {
        ...
        switch (type) {
            ...
            case 'Reference':
                ...
                if (this.type[0].code === 'CodeableReference') {
                    ...
                    const existing = (_e = (_d = this.fixedCodeableReference) !== null && _d !== void 0 ? _d : this.patternCodeableReference) !== null && _e !== void 0 ? _e : this.assignedByAnyParent();
                    const codeableReference = { reference: value.toFHIRReference() };
                    if ((existing === null || existing === void 0 ? void 0 : existing.concept) != null) {
            ...
            case 'Canonical':
                ...
                let canonicalDefinition = fisher.fishForMetadata(value.entityName, utils_1.Type.Resource, utils_1.Type.Logical, utils_1.Type.Type, utils_1.Type.Profile, utils_1.Type.Extension, utils_1.Type.ValueSet, utils_1.Type.CodeSystem, utils_1.Type.Instance);
                let canonicalUrl;
                if (!this.typeSatisfiesTargetProfile(canonicalDefinition === null || canonicalDefinition === void 0 ? void 0 : canonicalDefinition.resourceType, value.sourceInfo, fisher)) {
                    ...
                    const allMatchingMetadatas = fisher.fishForMetadatas(value.entityName, utils_1.Type.Resource, utils_1.Type.Logical, utils_1.Type.Type, utils_1.Type.Profile, utils_1.Type.Extension, utils_1.Type.ValueSet, utils_1.Type.CodeSystem, utils_1.Type.Instance);
                    const otherCanonicalDefinition = allMatchingMetadatas.find(md => this.typeSatisfiesTargetProfile(md === null || md === void 0 ? void 0 : md.resourceType, value.sourceInfo, fisher));
            ...
            case 'InstanceDefinition':
                ...
                this.assignFHIRValue(stringVal, value.toJSON(), exactly, (_f = value._instanceMeta.sdType) !== null && _f !== void 0 ? _f : value.resourceType, fisher);
                break;
            default:
                type = (_h = (typeof value === 'object' && ((_g = value.constructor) === null || _g === void 0 ? void 0 : _g.name))) !== null && _h !== void 0 ? _h : type;
    ...
    checkXhtml(value) {
        try {
            ...
            return sax_1.default.parser(true).write(value).error == null;
        }
        catch (_a) {
            return false;
        }
    ...
    assignFshCode(code, exactly = false, fisher) {
        ...
        if (type === 'code' || type === 'string' || type === 'uri') {
            ...
            const existing = (_f = (_e = this.fixedCodeableReference) !== null && _e !== void 0 ? _e : this.patternCodeableReference) !== null && _f !== void 0 ? _f : this.assignedByAnyParent();
            const codeableReference = { concept: code.toFHIRCodeableConcept() };
            if ((existing === null || existing === void 0 ? void 0 : existing.reference) != null) {
    ...
    slicedElement() {
        var _a, _b;
        if (this.sliceName) {
            return ((_b = (_a = this.parent()) === null || _a === void 0 ? void 0 : _a.children(true)) !== null && _b !== void 0 ? _b : this.structDef.elements).find(e => e.id === this.id.slice(0, this.id.lastIndexOf(':')));
        }
    }
    /**
    ...
    unfold(fisher) {
        ...
        if (proceedToUnfold) {
            ...
            if (this.contentReference) {
                ...
                const json = fisher.fishForFHIR(type, utils_1.Type.Resource, utils_1.Type.Logical);
                ...
                if (slicedElement != null) {
                    ...
                    else if (slicedElement.type.length === 1 &&
                        ((_d = slicedElement.type[0].profile) === null || _d === void 0 ? void 0 : _d.length) === 1 &&
                    ...
                    utils_1.logger.debug(`Could not get sliced element for ${this.id}: StructureDefinition ${this.structDef.id} may be missing slicing information`);
                }
            }
            if (newElements.length === 0) {
                ...
                if (((_e = this.structDef) === null || _e === void 0 ? void 0 : _e.kind) === 'logical') {
