 ...
 */
router.get('/valuesets', async (req: Request, res: Response<ValueSetListResponse | ErrorResponse>) => {
  try {
    ...
    const response: ValueSetListResponse = {
      success: true,
 ...
 */
router.get('/decision-tables', async (req: Request, res: Response<DecisionTableListResponse | ErrorResponse>) => {
  try {
    ...
    const response: DecisionTableListResponse = {
      success: true,
      timestamp: new Date().toISOString(),
 ...
 */
router.get('/business-processes', async (req: Request, res: Response<BusinessProcessListResponse | ErrorResponse>) => {
  try {
    ...
    const response: BusinessProcessListResponse = {
      success: true,
      timestamp: new Date().toISOString(),
 ...
 */
router.get('/personas', async (req: Request, res: Response<PersonaListResponse | ErrorResponse>) => {
  try {
 ...
 */
router.get('/questionnaires', async (req: Request, res: Response<QuestionnaireListResponse | ErrorResponse>) => {
  try {
