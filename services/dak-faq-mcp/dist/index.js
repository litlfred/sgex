...
app.get('/mcp/daks', async (req, res) => {
    try {
...
app.get('/mcp/daks/status', async (req, res) => {
    try {
...
app.post('/mcp/daks/scan', async (req, res) => {
    try {
...
app.post('/mcp/daks/profiles', async (req, res) => {
    try {
...
app.post('/mcp/daks/repositories', async (req, res) => {
    try {
