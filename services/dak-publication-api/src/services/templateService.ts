import { Template, TemplateSection, TemplateVariable } from '../types/template';
...
export class TemplateService {
  ...
  async createTemplate(templateData: Omit<Template, 'id' | 'metadata'>): Promise<Template> {
