 ...
 * - Translation resources for UN languages
 ...
 * @example "en"
 */
export type LanguageCode = 'en' | 'fr' | 'es' | 'ar' | 'zh' | 'ru';

/**
 * Translation resource structure
 * @example { "en": { "translation": { "key": "value" } } }
 */
 ...
 * Maps language codes to their translation objects
 * 
 * @example
 ...
 * Initializes internationalization with language detection and React integration
 */
i18n
