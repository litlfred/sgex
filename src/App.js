    ...
    <Router basename="/sgex">
      <div className="App">
          <Routes>
            ...
            <Route path="/testing-viewer/:user/:repo/:branch/:asset" element={<TestingViewer />} />
            ...
            <Route path="/core-data-dictionary-viewer/:user/:repo/:branch/:asset" element={<CoreDataDictionaryViewer />} />
            ...
            <Route path="/health-interventions/:user/:repo/:branch/:asset" element={<ComponentEditor />} />
            ...
            <Route path="/actor-editor/:user/:repo/:branch/:asset" element={<ActorEditor />} />
            ...
            <Route path="/bpmn-editor/:user/:repo/:branch/:asset" element={<BPMNEditor />} />
            ...
            <Route path="/bpmn-source/:user/:repo/:branch/:asset" element={<BPMNSource />} />
            ...
            <Route path="/decision-support-logic/:user/:repo/:branch/:asset" element={<DecisionSupportLogicView />} />
