    ...
    const initializeViewer = async () => {
      try {
        ...
        const waitForDiagramBounds = () => {
          return new Promise((resolve, reject) => {
            ...
            const checkBounds = () => {
              ...
              console.log(`[BPMN ViewerEnhanced] Checking diagram bounds (attempt ${attempts + 1}):`, {
                outer: outer,
              ...
              if (outer && outer.width > 0 && outer.height > 0) {
                console.log(`[BPMN ViewerEnhanced] Valid diagram bounds found after ${attempts} RAF cycles`);
                resolve();
        ...
        try {
          ...
          console.log('✅ BPMNViewerEnhanced: Diagram bounds are valid, proceeding with zoom');
        } catch (boundsError) {
          console.error('❌ BPMNViewerEnhanced: Failed to get valid diagram bounds:', boundsError);
